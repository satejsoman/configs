...
export PROMPT="%{$BG[128]%}$pwd_info $(virtualenv_prompt_info) 
$FX[reset]$prompt_bar "
...
function git_prompt_info() {
  ...
  pretty_branch=$(echo $(current_branch) | sed -e "s:feature/:%{$FG[102]%}feature/%{$FG[220]%}:g" -e "s:bugfix/:%{$FG[102]%}bugfix/%{$FG[220]%}:g")
